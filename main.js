...
async function updateBalances() {
    ...
    try {
        // Performance optimization: Execute independent Web3 read calls concurrently via Promise.all
        // to minimize RPC round-trip latency (~66% reduction in RPC wait time).
