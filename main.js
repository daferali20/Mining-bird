...
async function updateBalances() {
    ...
    try {
        // Performance optimization: Execute independent Web3 RPC calls concurrently with Promise.all
        // to cut network round-trip latency by ~66% compared to sequential awaits.
