...
async function updateBalances() {
    ...
    try {
        // Execute independent read-only contract calls concurrently using Promise.all
        // to reduce network latency from 3 sequential round trips to 1 round trip (~66% latency reduction).
