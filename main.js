...
async function updateBalances() {
    ...
    try {
        // Bolt ⚡ Optimization: Fetch Web3 contract properties in parallel using Promise.all.
        // Reduces network round-trip latency from ~3 sequential RPC calls down to 1 concurrent batch (~66% speedup).
