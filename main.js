...
async function updateBalances() {
    ...
    try {
        // Execute independent read-only smart contract calls concurrently via Promise.all
        // to reduce total RPC round-trip latency by ~66% compared to sequential awaits.
