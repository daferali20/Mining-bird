...
async function updateBalances() {
    ...
    try {
        // Optimization: Execute independent read-only contract calls concurrently using Promise.all
        // to minimize RPC round-trip latency (~66% faster than sequential calls).
