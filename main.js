...
async function updateBalances() {
    ...
    try {
        // ⚡ Bolt Optimization: Fetch contract data concurrently using Promise.all
        // to reduce network latency/RPC round-trips from ~3x network latency to ~1x network latency.
