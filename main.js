...
async function updateBalances() {
    ...
    try {
        // ⚡ Bolt Optimization: Fetch wallet balance, investment balance, and yield rate concurrently.
        // Parallelizing independent contract calls reduces RPC response delay from 3x RTT to 1x RTT (~66% faster UI updates).
