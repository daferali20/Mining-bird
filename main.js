...
async function updateBalances() {
    ...
    try {
        // Optimize contract read queries: Fetch wallet balance, investment balance,
        // and yield rate concurrently via Promise.all to reduce total RPC latency
        // from 3 x RTT down to 1 x RTT (~66% reduction in RPC wait time).
