...
async function updateBalances() {
    ...
    try {
        // Bolt Optimization: Execute RPC read calls concurrently using Promise.all
        // Performance Impact: Reduces round-trip latency by ~66% (3 serial RPC calls -> 1 parallel request set)
